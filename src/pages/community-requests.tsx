...
import { loadJoinTeam, updateEnquiryStatus } from "../services/dashboard";
...
export default function CommunityRequestsPage() {
  ...
  const _loadDatas = async (page_: number, search_: string) => {
    await loadJoinTeam(page_, search_);
  };
    ...
    <div className="p-8">
      <div className="flex justify-between">
        <div className="text-xl">
          <span className="text-[#4F8FE1] font-bold ">Join Our Community Requests</span>{" "}
          ({total})
        </div>
      </div>
