...
import { loadContactUs, updateEnquiryStatus } from "../services/dashboard";
...
export default function ContactUsPage() {
  ...
  const _loadDatas = async (page_: number, search_: string) => {
    await loadContactUs(page_, search_);
  };
    ...
    <div className="p-8">
      <div className="flex justify-between">
        <div className="text-xl">
          <span className="text-[#4F8FE1] font-bold ">Contact Us Requests</span>{" "}
          ({total})
        </div>
      </div>
